...
public protocol MFTContextDeduplicating: NSObjectProtocol {
    /**
...
public class MFTDeduplicationManager: NSObject {
    
    public weak var deduplicator: MFTContextDeduplicating?
                        ...
                        if let results = try context.executeFetchRequest(fetchRequest) as? [NSManagedObject] {
                            ...
                            for (idx, obj) in results.enumerate() {
                                ...
                                if previousManagedObject != nil {
                                    if !obj.mft_isEqualToManagedObject(previousManagedObject!, forUniqueAttributes: uniqueAttributes) {
...
extension NSManagedObject {
    ...
    func mft_isEqualToManagedObject(object: NSManagedObject, forUniqueAttributes uniqueAttributes: [String]) -> Bool {
        var mismatch = false
